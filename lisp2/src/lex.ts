...
import { isalpha, isalnum, isdigit, isspace } from "./ctype";
...
export default class Lexer {
    ...
    constructor () {
        ...
        this.keywords.set("let", Toktype.LET);
        this.keywords.set("cond", Toktype.COND);
        this.keywords.set("else", Toktype.ELSE);
    }
